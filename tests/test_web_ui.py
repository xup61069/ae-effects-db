...
SORT = (ROOT / "assets" / "sort.js").read_text(encoding="utf-8")
...
class WebUiContractTests(unittest.TestCase):
    def test_native_module_shell_and_sort_modes(self):
        ...
        self.assertIn('if (mode === "relevance" && hasTerms)', SORT)
        self.assertIn('from "./sort.js"', APP)
        self.assertIn("sortLabelByMode[option.value]", APP)
        self.assertIn('latest:"sortLatest"', APP)
